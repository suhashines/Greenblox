...
export default function RecipeReviewCard() {
  ...
  const handleExpandClick = () => {
    setExpanded(false);
    navigate('/investor/opportunities/details');
  };
  ...
  return (
    <Card sx={{ maxWidth: 440 }}>
      <CardHeader
        ...
        title="Lannister Corporation"
        subheader="September 14, 2016"
      />
      <CardMedia
        component="img"
        height="230"
        image="https://media.licdn.com/dms/image/D4D12AQEIEYQ3dyHT5A/article-cover_image-shrink_720_1280/0/1693203188965?e=2147483647&v=beta&t=mH4ZuECjje0NGB3Wdjd5wou-mxfB7LgQxMNITIoi1Fk"
        alt="Paella dish"
      />
      <CardContent>
